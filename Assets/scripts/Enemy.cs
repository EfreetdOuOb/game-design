...
public class Enemy : MonoBehaviour
{
    ...
    public void TakeDamage(float _damage)
    {
        ...
        Debug.Log("怪物受到傷害，當前剩餘生命值: " + currentHealth + "/" + startingHealth);
    ...
    public void Face(Vector2 direction)
    {
        ...
        {
            GetComponentInChildren<SpriteRenderer>().flipX = true; // 面朝左
        }
        else if (direction.x > 0 && flipped)
        {
            GetComponentInChildren<SpriteRenderer>().flipX = false; // 面朝右
        }
    }
